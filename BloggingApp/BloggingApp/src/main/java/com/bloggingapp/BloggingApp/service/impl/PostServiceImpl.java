...
return  this.modelMapper.map(updatedPost ,PostDto.class);
    ...
    public PostResponse getAllPost(Integer pageNumber, Integer pageSize ,String sortBy, String sortDir){
        ...
        Pageable ps = PageRequest.of(pageNumber,pageSize, sort);
        Page<Post> pagePost=this.postRepo.findAll(ps);

        List<Post>allPosts=pagePost.getContent();
        List<PostDto>foundAll=allPosts.stream().map((post)->this.modelMapper.map(post,PostDto.class)).collect(Collectors.toList());
        PostResponse postResponse =new PostResponse();
        postResponse.setContent(foundAll);
